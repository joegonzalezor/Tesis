...
if [ -f /home/pi/carpeta/Tesis/pids/nombrered1.txt ]; then
   CADENA=$(head /home/pi/carpeta/Tesis/pids/nombrered1.txt)
else
   VARIABLE2=$(date +"%N" | cut -c 7,9)
   NOMBRE="TLON"
   CADENA="${NOMBRE}${VARIABLE2}"
   echo "${CADENA}" > /home/pi/carpeta/Tesis/pids/nombrered.txt
fi
